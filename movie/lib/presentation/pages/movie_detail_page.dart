...
import 'package:movie/common/color.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                if (!isAddedWatchlist) {
                                  context.read<WatchlistMovieBloc>().add(AddToWatchList(movie));
                                  
                                } else {
                                  context.read<WatchlistMovieBloc>().add(RemoveWatchList(movie));
                                }
                            ...
                            recommendations.length != 0 ? Container(
                              height: 150,
